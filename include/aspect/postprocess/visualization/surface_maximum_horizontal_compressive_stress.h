...
#ifndef _aspect_postprocess_visualization_surface_maximum_horizontal_compressive_stress_h
#define _aspect_postprocess_visualization_surface_maximum_horizontal_compressive_stress_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * stress, and outputs it on all boundary faces.
       *
       * The member functions are all implementations of those declared in the
       * base class. See there for their meaning.
       */
      template <int dim>
      class SurfaceMaximumHorizontalCompressiveStress
